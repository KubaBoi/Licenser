...
#REPOSITORIES
from cheese.repositories.licencesRepositoryImpl import LicencesRepositoryImpl
...
class CheeseRepository:
    ...
    def findAll(args):
        ...
        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.findAll(args)
    @staticmethod
    def find(args):
        userRepository = CheeseRepository.findUserRepository()
        args = CheeseRepository.getTypeOf(args)
        ...
        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.find(args)
    @staticmethod
    def findBy(args):
        userRepository = CheeseRepository.findUserRepository()
        args = CheeseRepository.getTypeOf(args)
        ...
        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.findBy(args)
    @staticmethod
    def findNewId(args):
        userRepository = CheeseRepository.findUserRepository()
        args = CheeseRepository.getTypeOf(args)
        ...
        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.findNewId(args)
    ...
    def save(args):
        ...
        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.save(args)
    @staticmethod
    def update(args):
        userRepository = CheeseRepository.findUserRepository()

        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.update(args)
    @staticmethod
    def delete(args):
        userRepository = CheeseRepository.findUserRepository()

        if (userRepository == "licencesRepository"):
            return LicencesRepositoryImpl.delete(args)


    @staticmethod
    def initRepositories():
        LicencesRepositoryImpl.init()
